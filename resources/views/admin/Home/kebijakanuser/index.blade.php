                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($data_kebijakan as $data)
                                            <tr>
                                                <td>{{ $data->judul }}</td>
                                                <td>{{ $data->heading }}</td>
                                                ...
                                                <td style="size: 20px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 text-end">
                                                            <form onsubmit="return confirm('Apakah anda yakin ?');" action="{{ route('kebijakanuser.destroy', $data->id)}}" method="POST">
                                                                @csrf
                                                                @method("DELETE")
    ...
    <div class="modal fade" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%; background-color: rgb(73, 73, 73)">
            <div class="modal-content">
                ...
                <form action="{{ url('/kebijakanuser')}}" method="POST" >
                    @csrf
    ...
    <div class="modal fade" id="ModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%; background-color: rgb(73, 73, 73)">
            <div class="modal-content">
                ...
                <form action="{{ url('/kebijakanuser/simpan')}}" method="POST" enctype="multipart/form-data">
                    @method("PUT")
                    @csrf
