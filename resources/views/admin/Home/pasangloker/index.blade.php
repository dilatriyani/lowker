                                                ...
                                                <td style="size: 20px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 text-end">
                                                            <form onsubmit="return confirm('Apakah anda yakin ?');" action="{{ route('pasangloker.destroy', $data->id)}}" method="POST">
                                                                @csrf
                                                                @method("DELETE")
    ...
    <div class="modal fade" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%">
            <div class="modal-content">
                ...
                <form action="{{ url('/pasangloker')}}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="ModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%">
            <div class="modal-content">
                ...
                <form action="{{ url('/pasangloker/simpan')}}" method="POST" enctype="multipart/form-data">
                    @method("PUT")
                    @csrf
